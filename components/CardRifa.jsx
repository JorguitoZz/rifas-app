    ...
    >
      ...
      >
        <div>
          ...
          <p className="text-[#94a3b8] text-[18px]">{descripcion}</p>
          ...
          <div className="flex flex-col gap-2 mt-3">
            ...
            <div className="w-full rounded bg-[#27272A]">
              <div
                className={`w-[${(vendidos / total) * 100}%] bg-[#e9b30e] h-[10px] rounded`}
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm mt-2">
            ...
            <p className="text-[17px] text-[#94a3b8]">{disponibles} Boletos disponibles</p>
          </div>
